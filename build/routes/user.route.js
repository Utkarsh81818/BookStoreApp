...
var router = _express["default"].Router(); //route to register users


router.post('/user', _user2.newUserValidator, (0, _auth.setRole)('user'), userController.newUser); //route to register users for admin

router.post('/admin', _user2.newUserValidator, (0, _auth.setRole)('admin'), userController.newUser); //routes for login API
